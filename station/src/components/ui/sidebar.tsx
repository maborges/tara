...
import { cloneElementWithProps, composeEventHandlers } from "@/components/ui/overlay-utils"
...
function SidebarProvider({
  ...
  // When collapsed but hovered, we treat it as expanded visually.
...
function Sidebar({
  ...
  // Allow hover to temporarily expand the sidebar
  const currentCollapsible = state === "collapsed" ? (isHovered ? "" : collapsible) : ""

  return (
    <div
      className="group peer hidden text-sidebar-foreground md:block z-50 shadow-xl transition-all duration-200"
      data-state={state}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      {...props}
      onClick={composeEventHandlers(props.onClick, () => toggleSidebar())}
    />
  )
}
...
function SidebarGroupLabel({
  ...
  return render ? cloneElementWithProps(render, baseProps) : <div {...baseProps} />
}
...
function SidebarGroupAction({
  ...
  return render ? cloneElementWithProps(render, baseProps) : <button type="button" {...baseProps} />
}
...
function SidebarMenuButton({
  ...
  const baseElement = render
    ? cloneElementWithProps(render, baseProps)
...
function SidebarMenuSubButton({
  ...
  return render ? cloneElementWithProps(render, baseProps) : <a {...baseProps} />
}
