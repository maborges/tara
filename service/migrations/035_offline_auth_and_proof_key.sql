-- Adiciona chave de prova na device configuration e cria autorizacoes offline
...
-- DOWN
DROP TABLE IF EXISTS tara.offline_capture_authorizations;

ALTER TABLE tara.device_configurations
    DROP COLUMN IF EXISTS proof_key_encrypted,
