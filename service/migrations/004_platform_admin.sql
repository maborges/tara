...
create table if not exists balanca.administradores_plataforma (
    id uuid primary key,
    usuario_id uuid not null unique references balanca.usuarios(id) on delete cascade,
...
grant select, insert, update, delete on balanca.administradores_plataforma to borgus;
