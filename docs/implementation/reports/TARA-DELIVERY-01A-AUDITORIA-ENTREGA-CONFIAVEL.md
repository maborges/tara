# TARA-DELIVERY-01A — Auditoria de Entrega Confiável de Pesagens

**Data:** 2026-08-24  
**Escopo auditado:** `/opt/lampp/htdocs/tara` e integração relevante em `/opt/lampp/htdocs/farm`
...
Serviço Balança (FastAPI)
    ├── PostgreSQL database farms / schema tara
...
- Balança: `README.md`, `CONTEXTO_IA_PLATAFORMA_TARA.md`,
...
- Farm: `docs/architecture/adr-tara.md`,
...
- Banco e schema próprios: `farms.tara`; não há necessidade de banco
...
- `POST /v1/auth/login` exige `X-Tenant-ID`; o bootstrap exige
  ...
  documentado em `CONTEXTO_IA_PLATAFORMA_TARA.md`.
...
- contar `tara.contas`, `ordens` e `pesagens`;
